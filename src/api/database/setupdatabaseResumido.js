  ...
  try {
    ...
    await db.execAsync(`
        PRAGMA journal_mode = WAL;
            ...
            INSERT INTO oracoes (title, oracao, tempo, icone) VALUES
            ('Credo Apostólico - Rosario','Pelo sinal da santa cruz, livrai-nos, Deus nosso Senhor, dos nossos inimigos.\nEm nome do Pai, e do Filho e do Espírito Santo. Amém.\n Divino Jesus, eu vos ofereço este Rosário que vou rezar, contemplando os mistérios de nossa Redenção. Concedei-me, pela intercessão de Maria, vossa Mãe Santíssima, a quem me dirijo, as graças necessárias para bem rezá-lo para ganhar as indulgências desta santa devoção.\nCreio em Deus, Pai todo-poderoso, Criador do Céu e da Terra E em Jesus Cristo, seu único Filho, nosso Senhor que foi concebido pelo poder do Espírito Santo; nasceu da Virgem Maria; padeceu sob Pôncio Pilatos, foi crucificado, morto e sepultado; desceu à mansão dos mortos; ressuscitou ao terceiro dia; subiu aos Céus; está sentado à direita de Deus Pai todo-poderoso, de onde há-de vir a julgar os vivos e os mortos. Creio no Espírito Santo; na santa Igreja Católica; na comunhão dos Santos; na remissão dos pecados; na ressurreição da carne; e na vida eterna. Amém.','110 segundos', '../../../assets/images/contaAveMaria.png'),
            ('Ave Maria - Anjo', 'O anjo do Senhor anunciou à Maria.\nE ela concebeu do Espírito Santo.\nAve Maria, cheia de graça, o Senhor é convosco. Bendita sois vós entre as mulheres, e bendito é o fruto do Vosso ventre, Jesus. Santa Maria, Mãe de Deus, rogai por nós, pecadores, agora e na hora da nossa morte. Amém.', '15 segundos', '../../../assets/images/contaAveMaria.png'),
            ('Ave Maria - Escrava ', 'Eis aqui a escrava do Senhor.\nFaça-se em mim segundo a Vossa palavra.\nAve Maria, cheia de graça, o Senhor é convosco. Bendita sois vós entre as mulheres, e bendito é o fruto do Vosso ventre, Jesus. Santa Maria, Mãe de Deus, rogai por nós, pecadores, agora e na hora da nossa morte. Amém.', '15 segundos', '../../../assets/images/contaAveMaria.png'),('Ave Maria - Verbo ', 'E o Verbo se fez carne.\nE habitou entre nós.\nAve Maria, cheia de graça, o Senhor é convosco. Bendita sois vós entre as mulheres, e bendito é o fruto do Vosso ventre, Jesus. Santa Maria, Mãe de Deus, rogai por nós, pecadores, agora e na hora da nossa morte. Amém.', '15 segundos', '../../../assets/images/contaAveMaria.png'),
            ('Glória ao Pai - Comtemplação - Pai Nosso','Glória ao Pai, e ao Filho e ao Espírito Santo,\nAssim como era no princípio, agora e sempre, por todos os séculos dos séculos. Amém.\nÓ meu Jesus, perdoai-nos e livrai-nos do fogo do inferno, levai as almas todas para o céu e socorrei principalmente as que mais precisarem.\nNo Primeiro Mistério Gozoso contemplamos a Anunciação do Anjo a Nossa Senhora.\nPai Nosso que estais nos Céus,\nsantificado seja o vosso Nome,\nvenha a nós o vosso Reino,\nseja feita a vossa vontade\nassim na terra como no Céu.\nO pão nosso de cada dia nos dai hoje,\nperdoai-nos as nossas ofensas\nassim como nós perdoamos\na quem nos tem ofendido,\ne não nos deixeis cair em tentação,\nmas livrai-nos do Mal.\nAmém.', '30 segundos', '../../../assets/images/contaAveMaria.png');
